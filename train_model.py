...
if __name__ == "__main__":
    base_path = "/home/taisiya/labs/lab3"
    ...
    df_path = f"{base_path}/df_clear.csv"
    if not os.path.exists(df_path):
        print(f"Ошибка: Файл {df_path} не найден! Сначала запусти скрипт очистки данных.")
    else:
        ...
        print(f"Обучение завершено. Путь к лучшей модели сохранен в best_model.txt")
        print(f"Локальный путь к модели: {path2model}")
